...
From the routine questionnaire assessment battery (cf. Section&nbsp;\@ref(cha)), we selected a total of 64 features^[The complete list of features is provided in Appendix&nbsp;\@ref(appx-pheno).] from 14 questionnaires. 
...
```{r 06-treatment-effects, echo=FALSE, fig.align='center', out.width=if(knitr::is_latex_output()){"50%"}else{"100%"}, fig.cap="(ref:06-treatment-effects)"}
...
Patients in PT 4 (_stress group_) reported higher than average perceived stress, accompanied by physical exhaustion and anxious-depressed mood. 
